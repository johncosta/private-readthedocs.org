...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('projects_project', 'repo', self.gf('django.db.models.fields.CharField')(max_length=150))
    ...
    models = {
        ...
        'projects.project': {
            ...
            'repo': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
